...
export const ProductForm = ({
  ...
  const addTag = () => {
    ...
    //se añade el valor nuevo con "setValue" de react-hook-form
  ...
  const addSize = (size: Size) => {
    // Se obtienen los valores por defecto con "getValues" de react-hook-form
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Basic Information */}
            <div className="bg-background rounded-xl shadow-lg border border-slate-200 p-6">
              <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-400 mb-6">
              ...
              <div className="space-y-6">
                ...
                <fieldset>
                  ...
                  <input
                    ...
                    {...register("slug", {
                      validate: (value) =>
                        //verifica que no tenga espacios en blanco con un regex
                        !/\s/.test(value) ||
                        "Slug no puede contener espacios en blanco",
                    })}
                    className={cn(
                      "w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                      {
            ...
            {/* Sizes */}
            <fieldset className="bg-background rounded-xl shadow-lg border border-slate-200 p-6">
              <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-400  mb-6">
                Tallas disponibles
              </h2>
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-sm font-medium transition-all duration-200 ${
                        selectedSizes.includes(size)
                          ...
                          : "bg-slate-200 text-slate-700 dark:bg-green-300 hover:bg-slate-300 cursor-pointer"
                      }`}
                    >
                      {size}
                    </button>
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-2">
                  {selectedTags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 dark:bg-white text-green-800 dark:text-green-400 border border-green-200"
                    >
            ...
            <div className="bg-background rounded-xl shadow-lg border border-slate-200 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                  ...
                  <span className="px-2 py-1 text-xs font-medium bg-green-100 dark:bg-green-300 text-green-800 rounded-full">
                    Activo
                  </span>
                </div>
