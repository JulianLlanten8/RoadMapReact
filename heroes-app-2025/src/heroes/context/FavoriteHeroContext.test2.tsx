...
const mockHero = { id: "1", name: "batman" } as Hero;
...
describe("FavoriteHeroContext", () => {
  ...
  // Se espera que el contexto se inicialice con los valores por defecto
  ...
  // Se espera que el botón agregue el favorito
  test("should add hero to favorites when toggleFavorite", () => {
    renderConstextTest();
  ...
  // Se espera que el botón quite el favorito
  test("should remove hero from favorites when toggleFavorite is called", () => {
    ...
    // Se espera que no exista el elemento con
