...
export const HeroPage = () => {
  ...
  const getStatusColor = (status: string = "activo") => {
  ...
  const getCategoryColor = (category: string = "héroe") => {
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative">
              <img
                src={superHeroData?.img || "/placeholder.svg"}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress value={superHeroData?.strength ?? 1 * 10} className="h-2" />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={superHeroData?.intelligence ?? 1 * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress value={superHeroData?.speed ?? 1 * 10} className="h-2" />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={superHeroData?.durability ?? 1 * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <Progress
                        value={superHeroData?.strength ?? 1 * 10}
                        className="h-4"
                      />
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <Progress value={superHeroData?.speed ?? 1 * 10} className="h-4" />
                    </div>
                    <div className="w-12 text-right font-bold">
