...
import { Eye, Zap, Brain, Gauge, Shield, Heart } from "lucide-react";
    ...
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
      <div className="relative h-64">
        ...
        {hero.universe === "DC" ? (
          ...
          <Badge className="absolute top-3 right-3 text-xs bg-red-400 text-white">
            {hero.universe}
          </Badge>
        )}
        ...
        >
          <Heart className="h-4 w-4 fill-red-600 text-red-500"></Heart>
        </Button>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-1">
            {hero.powers.slice(0, 3).map((power, key) => (
